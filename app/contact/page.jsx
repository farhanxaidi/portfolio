...
const info = [
  ...
  icon: <FaPhoneAlt/>,
  title: "Phone",
  description: "(+92) 309 8979449",
},
{
  icon: <FaEnvelope/>,
  title: "Email",
  description: "syedfarhanxaidi@gmail.com"
},
{
  icon: <FaMapMarkedAlt/>,
  title: "Address",
      ...
      <div className="container mx-auto">
        ...
        <div className="xl:w-[54%] order-2 xl:order-none">
          <form className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl">
            ...
            <p className="text-white/60">Lorem ipsum dolor sit amet consectetur adipisicing elit. Odio ex unde esse accusamus.</p>
